...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("\n==== QUICKSORT ====");
        quicksort(clasificador, "ascendente", ascendente);
        quicksort(clasificador, "descendente", descendente);
        quicksort(clasificador, "aleatorio", aleatorio);
    ...
    static void quicksort(TClasificadorImp c, String tipo, int[] original) {
        int[] copia = original.clone();
        c.quicksort(copia);
        reportar("Quicksort", tipo, original, copia, c);
    }
